        ...
        <div className='mt-[5rem] flex items-center flex-col md:flex-row justify-between'>
            <div className='px-[2rem] lg:px-[5rem] w-full md:text-left text-center lg:w-[60%]'>
                ...
                <div className='flex items-center gap-[1rem] justify-center md:justify-start flex-col sm:flex-row'>
                    <button onClick={() => navigate('/login')} className='bg-[#2B91F3] py-[0.8rem] text-white rounded-full lg:w-[30%] w-[70%] px-[2rem] hover:shadow-lg'>Login</button>
                    <button onClick={() => navigate('/register')} className='border-2 border-[#2B91F3] py-[0.8rem] text-[#2B91F3] hover:shadow-lg rounded-full lg:w-[30%] w-[70%] px-[2rem]'>Register</button>
                </div>
            </div>
